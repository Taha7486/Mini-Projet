...
<head>
    ...
    <title>About - Campus Events</title>
        ...
        <div class="space-y-8">
            ...
            <div class="bg-white rounded-lg shadow-md p-6">
                ...
                <p class="text-gray-700 leading-relaxed">
                    Campus Events is designed to streamline event management across university campuses. 
            ...
            <div class="bg-white rounded-lg shadow-md p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="space-y-4">
                        ...
                        <div class="flex items-start gap-3">
                            <i class="fas fa-tools text-purple-600 mt-1"></i>
                            <div>
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="flex items-start gap-3">
                            <i class="fas fa-certificate text-red-600 mt-1"></i>
                            <div>
                                <h3 class="font-semibold text-gray-800">Attestations</h3>
                                <p class="text-gray-600 text-sm">Generate and send participation certificates automatically.</p>
                            </div>
                        </div>
                        <div class="flex items-start gap-3">
                            <i class="fas fa-shield-alt text-indigo-600 mt-1"></i>
                            <div>
            ...
            <div class="bg-white rounded-lg shadow-md p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <p class="text-gray-800 font-medium">support@campusevents.edu</p>
                    </div>
                    <div>
                        ...
                        <p class="text-gray-800 font-medium">info@campusevents.edu</p>
                    </div>
                </div>
            </div>
        </div>
