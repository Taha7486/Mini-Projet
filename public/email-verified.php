        ...
        <div class="bg-white rounded-lg shadow-lg p-8 text-center">
            ...
            <div class="space-y-4 mb-8">
                <p class="text-gray-600">
                    Merci pour votre inscription ! Votre adresse email a été validée avec succès.
                </p>
                <p class="text-gray-600">
                    Vous pouvez maintenant vous connecter à votre compte et commencer à participer aux événements.
                </p>
            </div>
